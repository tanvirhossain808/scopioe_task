const LoginButton = () => {
    return (
        <div className="px-4">
            <div className="flex justify-center gap-10 items-center mt-[50px]">
                <button className="bg-google-gradient shadow-google-shadow w-[146px] h-[45px] flex items-center justify-center rounded-[10px]">
