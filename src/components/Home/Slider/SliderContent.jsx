...
const SliderContent = ({ name, lived, contact, img }) => {
    return (
        <div className="group border-[#E7E7E7] border-[0.835px] max-h-[440px] rounded-lg max-w-[160px] transition-transform transform hover:scale-110 lg:hover:scale-100 lg:max-h-[305] lg:max-w-[215px]">
            <div className="w-full px-2 min-h-[] pt-2 ">
                <div>
                    <img src={img} alt="slider img" width={160} height={121} className="w-full h-auto" />
                </div>
                <div className="mt-4 px-1">
                    <h3 className="text-dark-black text-xs font-medium tracking-[.234px]">
                        {name}
                    </h3>
                </div>
                <div className="mt-[14px] text-[10px]">
                    <p className="flex items-center gap-1">
                        ...
                        <span className="text-[#5C635A] w-[132px]">
                            {lived}
                        </span>
                    </p>
                    <p className="mt-[10px] flex items-center gap-1">
                        <span>
