...
const SliderContent = ({ name, lived, contact, img }) => {
    return (
        <div className="w-[180px] px-2 pt-2">
            <div>
            ...
            <div className="mt-[14px]">
                <p className="flex items-center gap-1">
                    ...
                    <span className="text-[#5C635A] w-[132px] text-[13px]">
                        {lived}
                    </span>
                </p>
                <p className="mt-[10px] flex items-center gap-1">
                    <span>
                        <img src="/assets/images/logo/car.png" height={10} width={10} />
                    </span>
                    <span className="text-[#5C635A] text-[12px]">
                        {lived}
                    </span>
                </p>
            </div>
