...
const Home = () => {
    return (
        <>
            ...
            <div className="px-4 py-6 mt-[30px] bg-color-white lg:p-[30px] max-w-[1130px] w-full mx-auto flex flex-col lg:flex-row items-center lg:justify-between rounded-[10px]">
                <div className="">
